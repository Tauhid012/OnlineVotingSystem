...
<body>
	...
	<form action="/OnlineElectionSystem/voterSignUp" method="post"
		"border:1pxsolid#ccc">
		<div class="container">
			<h1>Sign Up</h1>
			...
			<label for="email"><b>Email</b></label> <input type="text"
				...
				for="father_name"><b>Father's Name</b></label> <input type="text"
			...
			<p>
				Sign Up as Voter you must agree with <a href="#"
					style="color: dodgerblue">Terms & Laws</a>.
			</p>
